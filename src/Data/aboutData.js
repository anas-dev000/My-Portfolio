const aboutData = {
  journey: {
    ...
    content: `              I began my journey as a computer science student passionate about
              ...
              diverse projects—from responsive frontend with React and Angular
  ...
  whatIDo: {
    ...
    list: [
      "Build secure & scalable APIs with Node.js, Express, and MongoDB/PostgreSQL.",
